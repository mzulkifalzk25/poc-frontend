...
export const en = {
  ...
  billing: {
    ...
    quickItemsEmpty: "No products in this category yet.",
    addQuick: (name: string, price: string) => `Add ${name}, ${price}`,
    currentBill: "Current bill",
    items: "items",
    totalToPay: "Total to pay",
    payment: {
      method: "Payment method",
      methods: { cash: "Cash", card: "Card", wallet: "Wallet" },
      quickCash: "Cash given",
      exact: "Exact",
      received: "Received",
  ...
  receipt: {
    bill: (billNo: string) => `Bill ${billNo}`,
    cashier: (name: string) => `Cashier: ${name}`,
    subtotal: "Subtotal",
    tax: (rate: string) => `Tax (${rate}%)`,
    rounding: "Rounding",
    total: "TOTAL",
    cashReceived: "Cash received",
    change: "Change",
    paidBy: (method: string) => `Paid by ${method}`,
    barcodeLabel: (billNo: string) => `Bill number barcode ${billNo}`,
  ...
  returns: {
    scanLabel: "Scan a returned item or search by name",
    scanPlaceholder: "Scan each returned item or type its name",
    tableLabel: "Returned items",
    item: "Returned item",
    refund: "Refund",
    emptyTitle: "Nothing to return yet",
    emptyHint: "Scan the first item the customer brought back.",
    note: "Refunds use today's selling price. Enter the bill number above to refund the price the customer actually paid.",
    todayPrice: "Today's price",
    fromBill: "From bill",
    pricePaid: "Price paid",
    notOnBill: "Not on this bill · today's price",
    summary: "Return summary",
    payBack: "Pay back to customer",
    items: (total: number) =>
  ...
  posNav: {
    returns: "Returns",
    held: "Held bills",
    heldCount: (total: number) => `Held bills · ${count(total)}`,
    endShift: "End shift",
    store: "Store",
  },
  deactivated: {
